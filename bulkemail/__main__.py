...
user_input = input(f"""You are about to email {len(BulkEmail.get_recipient_list())} {"people" if len(BulkEmail.get_recipient_list())!=1 else "person"}. Are you sure about this?
